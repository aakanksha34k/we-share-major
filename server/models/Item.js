...
const itemSchema = new mongoose.Schema({
  ...
  category: { type: String, enum: ['Books', 'Stationery', 'Lab Gear', 'Electronics', 'Other'] },
  ...
  detailedLocation: { type: String, trim: true, maxlength: 500, default: '' },
  pickupCoordinates: {
  ...
  status: {
    type: String,
    enum: ['pending', 'available', 'reserved', 'lent', 'draft', 'removed', 'rejected'],
    default: 'pending'
  },
